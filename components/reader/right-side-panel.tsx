          ...
          <div className="p-5">
            <TabsContent value="toc" className="mt-0 space-y-1">
              ...
              <nav className="space-y-0.5">
                {[
                  { num: 1, title: "The Beginning", active: false },
                  { num: 2, title: "Rising Action", active: true },
                  { num: 3, title: "The Climax", active: false },
                  { num: 4, title: "Falling Action", active: false },
                  { num: 5, title: "Resolution", active: false },
                ].map((chapter) => (
                  <Button
                    key={chapter.num}
                    variant="ghost"
                    className={`w-full justify-between text-sm font-normal h-auto py-3 px-3 rounded-xl hover:bg-secondary/80 ${chapter.active ? "bg-primary/5 text-primary" : ""}`}
                  >
                    <span className="text-left">
                      <span className="text-muted-foreground font-medium">Chapter {chapter.num}:</span> {chapter.title}
                    </span>
